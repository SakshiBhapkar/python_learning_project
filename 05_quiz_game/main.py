...
while choice != 4:
    ...
    if choice == 1:
        ...
        if category == 1:
            ...
            utilities.display_cyber_quiz(cyber_question, cyber_options, cyber_answers)
        ...
        # high_scores = {
        #     "Python": utilities.python_score(python_question, python_options, python_answers),
        #     "AIDS": utilities.aids_score(aids_question, aids_options, aids_answers),
        #     "Cyber Security": utilities.cyber_score(cyber_question, cyber_options, cyber_answers)
        # }
